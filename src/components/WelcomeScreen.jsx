...
// URL del logo en Dropbox (modo descarga directa)
const LOGO_URL =
  'https://www.dropbox.com/scl/fi/hncm75fzqdi93489tdljr/logo-lira-motors.png?rlkey=bn2a4pd6gbr6nhyazvm3pzvnx&st=unzs2dux&raw=1';
...
>
  ...
  <p className="text-xl text-gray-700">
    Reserva tu cita en menos de un minuto
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-3">{SHOP_DATA.address}</p>
        ...
        >
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Reserva online de forma fácil y rápida. Selecciona el servicio que
              necesitas, elige fecha y hora, y te contactaremos para confirmar
              tu cita.
            </p>
      ...
      >
        <p>
          © {new Date().getFullYear()} Taller Lira Motors. Todos los derechos
          reservados.
        </p>
      </motion.div>
    </div>
